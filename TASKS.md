...
3. **Optional deeper complex-PTSD coverage** — only if the project wants a genuine complex-PTSD label (build original DSO coverage, exposure/duration interpretation, boundaries, and tests).
